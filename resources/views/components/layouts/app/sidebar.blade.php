...
<body class="min-h-screen bg-white dark:bg-zinc-800">
    <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <flux:navlist variant="outline">
            ...
            {{-- Admin Menu - Hanya tampil untuk user dengan role admin --}}
            @admin
                <flux:navlist.group :heading="__('Admin')" class="grid">
                    ...
                    <flux:navlist.item icon="users" :href="route('admin.users')"
                        :current="request()->routeIs('admin.users')" wire:navigate>{{ __('Manajemen User') }}
                    </flux:navlist.item>
                    <flux:navlist.item icon="shield-check" :href="route('admin.roles')"
                        :current="request()->routeIs('admin.roles')" wire:navigate>{{ __('Manajemen Role') }}
                    </flux:navlist.item>
                </flux:navlist.group>
            @endadmin
        </flux:navlist>
